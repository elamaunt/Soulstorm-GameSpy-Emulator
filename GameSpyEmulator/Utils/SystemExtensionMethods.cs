...
namespace System
{
    internal static class SystemExtensionMethods
    {
        ...
        public static string ToUtf8(this byte[] buffer, int count)
        {
            return Encoding.UTF8.GetString(buffer, 0, count);
        }

        public static string ToASCII(this byte[] buffer, int count)
        {
            return Encoding.ASCII.GetString(buffer, 0, count);
        }

        public static string ToAsciiString(this byte[] self)
        {
            return Encoding.ASCII.GetString(self);
        }
        ...
        public static long ParseToLongOrDefault(this string self, long defaultValue = 0)
        {
